...
HD_PWD='C:/Users/Hp/I2C_n_Verilg/I2C_n_Verilg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_Protocol.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2C_Protocol.tcl
